...
function alterarImagemPersonagemGrande(personagem) {
    ...
    if (idPersonagem === 'cait-sith' || idPersonagem === 'cid' || idPersonagem === 'red-xiii') {
        imagemPersongaemGrande.src = `./assets/imagens2/${idPersonagem}.webp`;
    } else {
        imagemPersongaemGrande.src = `./assets/imagens2/${idPersonagem}.png`;
    }
}
